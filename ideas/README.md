...
| 文件 | 维度 | Ideas 数 | P0 |
|------|------|---------|-----|
| [tokenizer.md](tokenizer.md) | 量化方法 (RQ/OPQ/FSQ/Balanced/Co-gen/Collision/Capacity) | 9 | sid-0 |
| [embedding.md](embedding.md) | 表征增强 (协同/多模态/属性/Caption) | 6 | — |
| [architecture.md](architecture.md) | 模型架构 (LazyAR/QFormer/SoftPrompt/Reasoning/Diffusion/CoA/MultiStream/Session-MIM) | 17 | — |
| [training.md](training.md) | 训练目标 (Contrastive/MTP/Value/ENTP/NSP/TaskDecomp/MultiBiz) | 13 | onemall-0 |
...
上述原则经过 EXP-003 ~ EXP-009 六轮实验后，有以下修正和确认：
