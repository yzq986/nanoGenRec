...
| 优先级 | ID | 实验 | 原因 |
|--------|-----|------|------|
| P0 | IDEA-onemall-5 | 立即执行 EXP-003 (ResKmeans+LearnedFSQ) | OneMall 直接验证方向正确，代码已就绪，conflict 36%→11% |
...
| P1 | IDEA-onemall-2 | GRPO/DPO 强化学习 | 战略重要但依赖强基线 + reward model，建议 IDEA-onemall-0/onemall-5 之后 |
| P1 | IDEA-onemall-1 | Query-Former 序列压缩 | 3.7x FLOP 减少，但需要更长序列场景才有意义 |
| P2 | IDEA-onemall-4 | Loss-Free MoE Balancing | 低风险低成本，但 8 experts 下收益可能有限 |
