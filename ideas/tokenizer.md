...
**优先级**: P1 (RQ 路线改进，与 OPQ 路线互斥，降级为对比基线)
...
| P1 | IDEA-gr4ad-0 | MGMR 不等大码本 | RQ 路线改进，作为 OPQ 对比基线 |
| P1 | IDEA-onemall-5 | RKMeans+FSQ (EXP-003 降级) | RQ 路线改进，作为 OPQ 对比基线 |
