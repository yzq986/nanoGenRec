...
│   └── EXP-017 SP-DPO ✅, EXP-018 RF-DPO pure DPO ❌ (forgetting), EXP-019 joint NTP+DPO 进行中
...
**状态**: 实验中 — EXP-017 SP-DPO ✅ R@10 15.4%, EXP-018 RF-DPO pure DPO ❌ forgetting, EXP-019 joint NTP+DPO 进行中
...
| **P1** | **IDEA-rpo-0** | **RPO: SFT Loss as DPO Regularizer** | **NeurIPS 2024 理论证明, 我们 EXP-019 joint NTP+DPO 的理论基础** |
| **P1** | **IDEA-spot-0** | **Elastic Tether: β 自适应正则化** | **HKU 2026, 解释 EXP-018 β ablation 结果** |
