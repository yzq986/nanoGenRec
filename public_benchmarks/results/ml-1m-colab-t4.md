...
[ml-1m-baselines.md](ml-1m-baselines.md) for transparency and debugging. This
hybrid-feature run is retained as an earlier reproducibility record rather than
