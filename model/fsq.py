...
FSQ_LEVEL_CONFIGS = {
    ...
    '11d_2048': [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],    # 2048 exact (binary)
    '6d_2048':  [4, 4, 4, 4, 4, 2],                     # 2048 exact (mixed)
    '13d_8192': [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],  # 8192 exact (binary)
    '7d_8192':  [4, 4, 4, 4, 4, 4, 2],                  # 8192 exact (mixed)
}
