...
NUMERIC_CHECKS = [
    ...
    NumericCheck("MovieLens 1M hybrid Colab T4", "public_benchmarks/results/ml-1m-colab-t4.md", "ml-1m", "nanoGenRec hybrid", ("5,950", "3,532", "348,363", "10.5%", "40.4%", "72.5%", "85.2%")),
    NumericCheck("MovieLens 1M Qwen RL Colab T4", "public_benchmarks/results/ml-1m-qwen-rl-t4.md", "ml-1m-qwen-rl", "nanoGenRec Qwen+RL", ("5,950", "3,532", "348,363", "10.0%", "38.4%", "72.2%", "86.0%")),
    ...
    NumericCheck("MovieLens popularity baseline", "public_benchmarks/results/ml-1m-baselines.md", "Popularity", "Popularity", ("2.2%", "20.6%", "56.1%", "74.7%")),
    NumericCheck("MovieLens itemKNN baseline", "public_benchmarks/results/ml-1m-baselines.md", "ItemKNN", "ItemKNN", ("13.9%", "46.6%", "78.0%", "88.5%")),
]
