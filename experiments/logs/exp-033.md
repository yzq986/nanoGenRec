...
**Date**: 2026-04-28
**Status**: completed
**Results**: [experiments/ntp_checkpoints/exp033-features-fix/](../ntp_checkpoints/exp033-features-fix/)
...
| Indicators | EXP-033 (features fix) | EXP-031A (features bug) | baseline exp020 |
|------|------------------------|------------------------|-----------------|
| R@10 | **10.3%** | 10.5% | 14.1% |
