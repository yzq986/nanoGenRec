...
- **优先**：以 exp036-full-features 为 SFT 起点，重跑 ECPO（参考 EXP-029 配置），验证 features NTP + ECPO 能否超越当前 RL SOTA（exp029，R@500=67.8%）
- 若 features RL 超越 67.8%：建立新 SOTA，继续在 features 路线上做 RL 迭代
- 若 features RL 持平或更差：说明 RL 阶段 features 边际收益不大，维持 exp020→exp029 路线
