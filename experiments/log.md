...
| opq-3x{1024,2048,4096,8192} | OPQ | — | — | 30/33/36/39 |

- **Fixed**: Qwen3-0.6B 1024D, MLP hidden=64, 50 epochs
- **Metrics (4 only)**: semantic_neighbor_HR, collision, codebook_utilization, cluster_balance
- **Multi-GPU**: 4 KMeans groups 并行
- **Merge EXP-011**: 已有 4 组结果直接合并

### Run

```bash
python experiments/scripts/exp-012-grid.py --gpus 0,1,2,3
```
